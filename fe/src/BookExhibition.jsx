...
function BookExhibition() {
  ...
  return (
    <div className="book-exhibition" style={{ backgroundColor: bgColor }}>
            ...
            {slides.map((slide, index) => (
              <div className="embla__slide" key={slide.id}>
                <div 
                  ...
                  style={{ '--slide-color': imageRefs.current[index] || 'rgba(0, 0, 0, 0.6)' }}
                >
